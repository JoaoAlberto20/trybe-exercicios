...
/* const persons = [
    { firstName: 'Maria', lastName: 'Ferreira' }, { firstName: 'João', lastName: 'Silva' }, { firstName: 'Antonio', lastName: 'Cabral' },
];
...
const allStudents = estudantes.filter((estudante) => (estudante.turno === 'Manhã'));
const allNameStudents = allStudents.map((student) => `${student.nome} ${student.sobrenome}`);
